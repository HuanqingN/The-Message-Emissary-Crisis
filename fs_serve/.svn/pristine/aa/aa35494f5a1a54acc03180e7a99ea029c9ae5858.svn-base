package  filter{
	...
	public class ImageFilter {
		...
		public static function saturation(source:Sprite,rp:Number=1,gp:Number=1,bp:Number=1) {
			var matrix:Array = new Array();
