package core.mng
{
	...
	public class Evt extends EventDispatcher 
	{
		...
		public static const onMessageShow:String="onmessageshow"; 
		public static var onCollectionViewShow:String="oncollectionviewshow"; 
		public static var onSettingViewShow:String="onsettingviewshow"; 
		public static var onMsgViewShow:String="onMsgViewShow"; 
