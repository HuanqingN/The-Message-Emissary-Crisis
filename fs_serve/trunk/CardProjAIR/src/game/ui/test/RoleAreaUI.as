	...
	public class RoleAreaUI extends View {
		...
		protected static var uiXML:XML =
			<View width="140" height="196">
			  ...
			  <Label x="80" y="91" var="state" name="state" align="center" width="53" height="29" size="20" color="0xffff00" stroke="0" font="Microsoft YaHei" embedFonts="true" text=""/>
			  ...
			  <Label x="4" y="6" width="27" height="131" align="center" multiline="true" wordWrap="true" size="17" color="0xff33" stroke="0" selectable="false" mouseEnabled="false" var="pname" font="Microsoft YaHei" embedFonts="true"/>
			  ...
			  <Label text="提符最帅喵喵喵喵" x="36" y="29" align="right" bold="false" size="12" background="false" disabled="true" mouseEnabled="false" visible="false" stroke="0x0" color="0xffffff" var="hint" name="hint" width="97" height="18" autoSize="none"/>
			</View>;
