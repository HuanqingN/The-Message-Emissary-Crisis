...
//				p.hand.push(c);
		...
		private function onChangeStep(evt:WEvent):void  //切换流程
		{
			if(nowStep!=-1){
...
//				}
		...
		private function setRoleTurn(p:Player):void   //设置到玩家回合了
		{
		...
		private function start(d:Object):void
		{
			bv.setReport("选择角色阶段");
